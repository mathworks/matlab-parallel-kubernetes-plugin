...
[secretName, key] = iCreateUserCredSecret(environmentProperties, cluster, jobUID);
...
function [secretName, key] = iCreateUserCredSecret(environmentProperties, cluster, jobUID)
